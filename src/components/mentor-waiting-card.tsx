...
export function MentorWaitingCard({
  name,
  specialty,
  avatar,
  onAccept,
  onReject,
}: MentorWaitingCardProps) {
  return (
    <div className="flex items-center justify-between bg-white rounded-2xl border-0 p-4">
      <div className="flex items-center gap-6">
        ...
        <div className="flex flex-col gap-1 items-start">
          <h4 className="text-[16px] leading-6 font-semibold text-black">
            {name}
          </h4>
          <p className="text-[14px] leading-5 text-black/80 tracking-[0.01em]">
            {specialty}
          </p>
        </div>
      </div>
